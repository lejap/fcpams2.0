...
<head>
    ...
    <link rel="stylesheet" href="/fcpamsweb/assets/css/main.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="icon" type="image/png" href="/fcpamsweb/images/proflogo.png">
</head>
<body>
<div class="admin-wrapper">
    ...
    <header class="admin-header">
        <div style="display:flex;align-items:center;gap:0.75rem;">
            <?php if (file_exists($_SERVER['DOCUMENT_ROOT'] . '/fcpamsweb/images/bclogo.png')): ?>
            <img src="/fcpamsweb/images/bclogo.png" alt="FCPAMS Logo" style="height:34px;">
            <?php else: ?>
        ...
        <div style="display:flex;align-items:center;gap:1rem;">
            ...
            <a href="/fcpamsweb/logout.php" style="color:#ef4444;font-weight:700;font-size:0.85rem;display:flex;align-items:center;gap:0.3rem;text-decoration:none;">
